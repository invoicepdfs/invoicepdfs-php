...
/**
 * NumberingSequenceOut Class Doc Comment
 *
 * @category Class
 * @package  InvoicePDFs
 * @author   OpenAPI Generator team
 ...
 */
class NumberingSequenceOut implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'NumberingSequenceOut';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['date_pattern'] === null) {
            $invalidProperties[] = "'date_pattern' can't be null";
        }
