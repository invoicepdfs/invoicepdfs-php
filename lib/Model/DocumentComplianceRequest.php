...
/**
 * DocumentComplianceRequest Class Doc Comment
 *
 * @category Class
 * @package  InvoicePDFs
 * @author   OpenAPI Generator team
 ...
 */
class DocumentComplianceRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DocumentComplianceRequest';
    ...
    */
     ...
     * Sets profile
     *
     * @param string $profile Which ruleset to hold the document to. Rulesets differ: a document valid under one can be rejected by another, so there is no default.
     *
     * @return self
     */
