...
class StatsApi
{
    ...
    public function getStatsApiV1StatsGetWithHttpInfo(string $contentType = self::contentTypes['getStatsApiV1StatsGet'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\InvoicePDFs\Model\StatsResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\InvoicePDFs\Model\StatsResponse' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\InvoicePDFs\Model\StatsResponse', []),
