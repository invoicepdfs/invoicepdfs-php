...
class JobsApi
{
     ...
     * @throws \InvoicePDFs\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \InvoicePDFs\Model\JobsListResponse|\InvoicePDFs\Model\ApiErrorResponse
     */
    public function listJobs($limit = 50, $cursor = null, string $contentType = self::contentTypes['listJobs'][0])
    {
        list($response) = $this->listJobsWithHttpInfo($limit, $cursor, $contentType);
        return $response;
    }
     ...
     * @throws \InvoicePDFs\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \InvoicePDFs\Model\JobsListResponse|\InvoicePDFs\Model\ApiErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function listJobsWithHttpInfo($limit = 50, $cursor = null, string $contentType = self::contentTypes['listJobs'][0])
    {
        $request = $this->listJobsRequest($limit, $cursor, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\InvoicePDFs\Model\JobsListResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\InvoicePDFs\Model\JobsListResponse' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\InvoicePDFs\Model\JobsListResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 422:
            ...
            $returnType = '\InvoicePDFs\Model\JobsListResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\InvoicePDFs\Model\JobsListResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listJobsAsync($limit = 50, $cursor = null, string $contentType = self::contentTypes['listJobs'][0])
    {
        return $this->listJobsAsyncWithHttpInfo($limit, $cursor, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listJobsAsyncWithHttpInfo($limit = 50, $cursor = null, string $contentType = self::contentTypes['listJobs'][0])
    {
        $returnType = '\InvoicePDFs\Model\JobsListResponse';
        $request = $this->listJobsRequest($limit, $cursor, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function listJobsRequest($limit = 50, $cursor = null, string $contentType = self::contentTypes['listJobs'][0])
    {
