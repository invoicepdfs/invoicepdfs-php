...
```php
updateOverageSettings($billing_overage_request): \InvoicePDFs\Model\BillingOverageResponse
```
...
$billing_overage_request = new \InvoicePDFs\Model\BillingOverageRequest(); // \InvoicePDFs\Model\BillingOverageRequest

try {
    $result = $apiInstance->updateOverageSettings($billing_overage_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling BillingApi->updateOverageSettings: ', $e->getMessage(), PHP_EOL;
}
```
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **billing_overage_request** | [**\InvoicePDFs\Model\BillingOverageRequest**](../Model/BillingOverageRequest.md)|  | |

### Return type

[**\InvoicePDFs\Model\BillingOverageResponse**](../Model/BillingOverageResponse.md)
